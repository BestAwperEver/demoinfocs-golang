...
const file_cstrike15_gcmessages_proto_rawDesc = "" +
	...
	"\x06values\x18\x03 \x03(\v2\x1c.OperationalStatisticElementR\x06values\"\xc1\x01\n" +
	...
	"rankTypeId\x12\x1d\n" +
	"\n" +
	"tv_control\x18\a \x01(\rR\ttvControl\"}\n" +
	...
	"\n" +
	"event_data\x18\x0e \x01(\x05R\teventData\"\xde\x01\n" +
	...
	"\x0eserver_address\x18\a \x01(\tR\rserverAddress\"\xf2\t\n" +
	...
	"\n" +
	"max_rounds\x18\x1f \x01(\rR\tmaxRounds\x1a+\n" +
	"\bDropInfo\x12\x1f\n" +
	...
	"\rexpected_cost\x18\x04 \x01(\rR\fexpectedCost\"\xaf\x02\n" +
	...
	"\x18operation_points_awarded\x18\x06 \x01(\rR\x16operationPointsAwarded\"\x94\x03\n" +
	...
	"\x0etournamentinfo\x18\x06 \x01(\v2#.CDataGCCStrike15_v2_TournamentInfoR\x0etournamentinfo\"\x88\x01\n" +
	"2CMsgGCCStrike15_v2_MatchListTournamentOperatorMgmt\x12\x18\n" +
	"\aeventid\x18\x01 \x01(\x05R\aeventid\x128\n" +
	"\amatches\x18\x02 \x03(\v2\x1e.CDataGCCStrike15_v2_MatchInfoR\amatches\"\xb9\x02\n" +
	...
	"\x0etime_initiated\x18\x02 \x01(\rR\rtimeInitiated\"\x9d\x01\n" +
	...
	"0k_EMsgGCCStrike15_v2_MatchmakingGC2ClientAbandon\x10\x98G\x127\n" +
	...
	"4k_EMsgGCCStrike15_v2_MatchListTournamentOperatorMgmt\x10\xffG*\x98\x01\n" +
	...
	"\x17k_EInitSystemResult_Max\x10\bB\x05H\x01\x80\x01\x00"
